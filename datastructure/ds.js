...
// returns the reversed version of that string. For example, if the input 
// is "Hello, World!", the output should be "!dlroW ,olleH".
...
// 3. Implement a stack: Implement a stack data structure in JavaScript. 
// The stack should have the following methods: 
// push (adds an element to the top of the stack), 
// pop (removes and returns the top element from the stack), 
// and isEmpty (checks if the stack is empty).
...
// 4. Find the first non-repeated character: Write a function that takes a string as input 
// and returns the first non-repeated character in the string. 
// For example, if the input is "aabbcddde", the output should be "c".
...
// 4. Find the first non-repeated character: Write a function that takes a string as input 
// and returns the all non-repeated character in the string. For example, 
// if the input is "aabbcddde", the output should be "ce".
